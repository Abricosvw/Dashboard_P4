...
void app_main(void) {
  ...
  // NOTE: Touch reset removed/simplified as GT911 driver is removed
  if (TOUCH_RST_IO >= 0) {
      ESP_LOGI(TAG, "   Performing Touch Reset...");
  ...
  board_init_touch(i2c1_bus); // Init touch driver (Empty function now)
